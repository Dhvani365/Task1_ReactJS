        ...
        <Navbar expand="lg" className="navbar">
            <Container fluid>
                ...
                <Form className="d-flex searchbar">
                    ...
                    />
                    <Button className="search-button" style={{backgroundColor: "#8064A2", width: "17%"}}><img className="search-btn-img" src={searchIcon} height="80%" width="80%"/></Button>
                </Form>
                ...
                <Navbar.Collapse id="navbarScroll">
                    ...
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-compass-fill" viewBox="0 0 16 16"
                            style={{width: "22px", height: "22px", marginTop: "22px", marginLeft: "50px", color: "#8064A2", cursor:"pointer"}}
                        >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-nut-fill" viewBox="0 0 16 16"
                            style={{width: "22px", height: "22px", marginTop: "22px", marginLeft: "20px", color: "#8064A2", cursor:"pointer"}}
                        >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bookmark-fill" viewBox="0 0 16 16"
                            style={{width: "20px", height: "20px", marginTop: "24px", marginLeft: "20px", color: "#8064A2", cursor:"pointer"}}
                        >
                            <path d="M2 2v13.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2"/>
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bell-fill bell-icon" viewBox="0 0 16 16"
                            style={{width: "20px", height: "20px", marginTop: "24px", marginLeft: "20px", color: "#8064A2", cursor:"pointer"}}
                        >
