...
function SignIn() {
    return (
        <>
            <button className="hero-btn"><img className='hero-btn-img' style={{height: "10%", width:"10%"}} src={GoogleImg}/>Continue with Google</button>
            <button className="hero-btn"><img className='hero-btn-img' style={{height: "10%", width:"10%"}} src={FacebookImg}/>Continue with Facebook</button>
            ...
            <div className='signin-bottom-div'>
                <input type="checkbox" className="rememberCkb" /><span className='rm-text'>Remember me</span>
